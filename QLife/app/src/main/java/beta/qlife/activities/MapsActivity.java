...
public class MapsActivity extends Fragment implements ActionbarFragment, OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, MapView, DrawerItem {
